<?php
/**
 * Apocrypha Theme Admin-Side Posts
 * Andrew Clayton
 * Version 1.0.0
 * 9-18-2014
 */
...
class Apoc_Postmeta {
	...
	function add_meta( $post_type , $post ) {
		...
		switch ( $post_type ) {
			...
			case 'post' :
				add_meta_box( 'apoc-post-seo' , 'Byline' , array( $this , 'display_seo' ) , $post_type , 'normal', 'high' );
	...
	function display_seo( $post , $box ) {
		...
		// Display the field ?>
		<p>
			<label for="apoc-meta-description">Short Post Description:</label>
			<br />
